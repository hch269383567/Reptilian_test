...
class Douyu1ScrapyPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        self.mysql_handler.insertOne(
            'insert into douyu1(name, hot,fangjianhao,tupian,fans) values(%s, %s, %s,%s,%s)',
            (item['name'], item['hot'], item['fangjianhao'], item['tupian'],item['fans']))
        # commit 提交
